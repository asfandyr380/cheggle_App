...
class SearchHistoryEvent extends StatefulWidget {
  SearchHistoryEvent({Key key}) : super(key: key);

  @override
  _SearchHistoryEventState createState() {
...
class _SearchHistoryEventState extends State<SearchHistoryEvent> {
  ...
  EventSearchDelegate _delegate = EventSearchDelegate();
  ...
  Future<ProductEventModel> _onSearch() async {
...
class EventSearchDelegate extends SearchDelegate<ProductEventModel> {
  EventSearchDelegate();
  ...
  Widget buildSuggestions(BuildContext context) {
    return SuggestionEventList(query: query);
  }

  @override
  Widget buildResults(BuildContext context) {
    return ResultEventList(query: query);
  }
