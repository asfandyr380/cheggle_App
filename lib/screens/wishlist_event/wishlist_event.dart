...
class WishListEvent extends StatefulWidget {
  WishListEvent({Key key}) : super(key: key);

  @override
  _WishListEventState createState() {
    return _WishListEventState();
  }
}

class _WishListEventState extends State<WishListEvent> {
  WishListEventPageModel _listPage;
  ...
  Future<void> _loadData() async {
    ...
    if (result.success) {
      setState(() {
        _listPage = WishListEventPageModel.fromJson(result.data);
      });
    }
  }
