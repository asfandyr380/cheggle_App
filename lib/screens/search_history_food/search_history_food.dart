...
import 'search_result_food_list.dart';
import 'search_suggest_food_list.dart';

class SearchHistoryFood extends StatefulWidget {
  SearchHistoryFood({Key key}) : super(key: key);

  @override
  _SearchHistoryFoodState createState() {
    return _SearchHistoryFoodState();
  }
}

class _SearchHistoryFoodState extends State<SearchHistoryFood> {
  SearchHistoryFoodPageModel _historyPage;
  FoodSearchDelegate _delegate = FoodSearchDelegate();
  ...
  Future<void> _loadData() async {
    ...
    if (result.success) {
      setState(() {
        _historyPage = SearchHistoryFoodPageModel.fromJson(result.data);
      });
    }
  }

  Future<ProductFoodModel> _onSearch() async {
...
class FoodSearchDelegate extends SearchDelegate<ProductFoodModel> {
  FoodSearchDelegate();
  ...
  Widget buildSuggestions(BuildContext context) {
    return SuggestionFoodList(query: query);
  }

  @override
  Widget buildResults(BuildContext context) {
    return ResultFoodList(query: query);
  }
