...
class AppProductRealEstateItem extends StatelessWidget {
  AppProductRealEstateItem({
    Key key,
    this.item,
    this.onPressed,
    this.type,
  ...
  final ProductRealEstateModel item;
  final ProductViewType type;
  final Function(ProductRealEstateModel) onPressed;
